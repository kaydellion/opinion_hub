    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= SITE_URL ?>actions.php?action=update_profile" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="lga" value="<?= htmlspecialchars($user['lga'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if ($user['profile_image']): ?>
                                <div class="mt-2">
                                    <img src="<?= SITE_URL ?>uploads/profiles/<?= $user['profile_image'] ?>" alt="Profile" class="img-thumbnail" style="max-width: 150px;">
                                </div>
                            <?php endif; ?>
                        </div>
